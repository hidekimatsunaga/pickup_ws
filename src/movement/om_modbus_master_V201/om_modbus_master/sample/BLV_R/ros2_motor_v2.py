...
# sys.path.append("/home/matsunaga-h/mtn_ws/src/om_modbus_master_V201/om_modbus_master/sample")
...
#             Twist, "cmd_vel", self.cmd_callback, const.QUEUE_SIZE
#         )
...
#                 th = th + robot_w*delta
#                 th = th % (2 * math.pi)
#                 quaternion = tf_transformations.quaternion_from_euler(0, 0, th)
...
#         msg.data[2] = left  # DDO運転速度(初期単位：r/min)
...
#         msg.data[8] = right  # DDO運転速度(初期単位：r/min)
...
class MyPublisher(Node):
    ...
    def set_drive_operation(self):
        ...
        msg.data[14] = back  # DDO運転速度(初期単位：r/min)
