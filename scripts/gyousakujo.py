...
# 読み込むCSVファイルのパスを指定
input_filepath = '/home/matsunaga-h/pickup_ws/rosbag/nearest_/aruco_motor_log_1020_130519.csv'
# 保存するCSVファイルのパスを指定
output_filepath = '/home/matsunaga-h/pickup_ws/rosbag/nearest_/aruco_motor_log_1020_130519_cleaned.csv'
